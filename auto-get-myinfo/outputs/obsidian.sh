...
# 設定からObsidianパスを取得（デフォルト値使用）
# 実際の実装では、yqやpythonで設定ファイルをパースする
OBSIDIAN_BASE_PATH="$HOME/Library/Mobile Documents/iCloud~md~obsidian/Documents/I-think-therefore-I-am/diary"
